...
if args.dataset == 'mosi':
    v_in = (35, 64)
    v_out = get_range(4, 79)
    a_in = (74, 128)
    a_out = get_range(19, 79)
    l_in = (300, 512)
    l_out = 79
    d_v = (35, 64, 4)
    d_a = (74, 128, 19)
...
def affect_tf(config):
    ...
    saved_model = './{}_tf_{}.pt'.format(args.dataset, ''.join(list(map(str, modalities))))
...
saved_model = os.path.join(logdir, '{}_tf_{}.pt'.format(args.dataset, ''.join(list(map(str, modalities)))))
