...
def get_dataloader(
        ...
        num_workers: int = 2, flatten_time_series: bool = False, task=None, robust_test=False, 
    ...
    test = DataLoader(MOSI(processed_dataset['test'], flatten_time_series, task=task, max_pad=max_pad, max_pad_num=max_seq_len, z_norm=z_norm), \
                      shuffle=False, num_workers=num_workers, batch_size=batch_size, collate_fn=process)
